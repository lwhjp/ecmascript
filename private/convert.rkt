...
(require/typed "function.rkt"
               [#:opaque ESFunction es-function?]
               [call/function (-> ESFunction Any Any * Any)])

(lazy-require/typed
 ["../lib/boolean.rkt" ([make-Boolean (-> ESBoolean ESObject)])]
 ["../lib/number.rkt" ([make-Number (-> ESNumber ESObject)])]
 ["../lib/string.rkt" ([make-String (-> ESString ESObject)])])
